...
- Does the PR reference a task in the sprint (fetch with `curl -s http://localhost:7432/api/v1/games/{game}/sprint-log`) or a feature in the spec (`curl -s http://localhost:7432/api/v1/specs/{game-name}`)?
